...
function Install ($arguments) {
    ...
    $mCompanyVersion = Get-Arg $arguments "-morecompany"
    $mCompanyUrl = "https://thunderstore.io/package/download/notnotnotswipez/MoreCompany/$mCompanyVersion/"
    $mCompanyStream = Request-Stream $mCompanyUrl
    Expand-Stream $mCompanyStream $lethalCompanyPath
